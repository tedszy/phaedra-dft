...
// if PVs[k].V is in the uniqueVertex array, then push its vertex label onto label_list.
// if PVs[k].V is not in uniqueVertex array, then push PVs[k] onto the end of unique_PVs list.
...
// Debugging.
for (int k=0; k<unique_PVs.length; ++k)
  write(string(unique_PVs[k].V.x) + ", " + string(unique_PVs[k].V.y) + ", " 
